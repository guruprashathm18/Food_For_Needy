...
<form action="Donar_add.php" method="post" class="modal-content">
<div class="inputdata">
<h3> New Donar Info</h3>
...
<br><br>
       <div class="clearfix">
        ...
        <button type="submit" name="btn" class="signupbtn">Add Donar</button>
<button onclick="location.href='http://localhost/FoodForNeedy/Admin/Donar_up.php'" type="button">Update</button>
